                  ...
                  if (field_name == "destination_Organization" || field_name == "source_Organization" ){
                    #
                      if ("organizationTypes" %in% names(irow_df)){
                        d_flows[i,paste0(prefix,"_","organizationTypes")]<-irow_df[t,"organizationTypes"]
                      }
                    #
                      if ("organizationSubTypes" %in% names(irow_df)){
                        d_flows[i,paste0(prefix,"_","organizationSubTypes")]<-irow_df[t,"organizationSubTypes"]
                      }
                    #
                    if ("organizationLevels" %in% names(irow_df)){
                        d_flows[i,paste0(prefix,"_","organizationLevels")]<-irow_df[t,"organizationLevels"]
                      }
                  }
              #--------------------------#
              }
